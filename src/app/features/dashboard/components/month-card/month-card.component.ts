...
@Component({
  ...
  template: `
    <div
      ...
      [class.hover:shadow-md]="!isFuture"
      [class.hover:-translate-y-0.5]="!isFuture"
      (click)="!isFuture && navigate()"
    >
      <div class="flex items-start justify-between mb-3">
        ...
        <span *ngIf="!isFuture && progress >= 100" class="text-2xl" title="All done!">🏆</span>
...
export class MonthCardComponent {
  ...
  get isFuture() { return this.monthKey > this.goalsService.currentMonthKey; }
  ...
  navigate(): void {
    this.router.navigate(['/goals', this.monthKey]);
  }
}
